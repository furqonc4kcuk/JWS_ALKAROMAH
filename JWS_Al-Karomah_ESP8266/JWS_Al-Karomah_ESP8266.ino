/*
   ...
   FITUR :  JADWAL SHOLAT 5 WAKTU DAN IMSAK, TANGGAL, SUHU, ALARAM ADZAN DAN IMSAK,
            DAN UBAH WAKTU LEWAT WIFI DENGAN BROWSER.


        Pin on  DS3231    NODEMCU
        SCL               D1 (GPIO 5)
        SDA               D2 (GPIO 4)
        VCC               3V
        GND               GND
                          D4 ----------------> Serial1 ke 8x10 LED
